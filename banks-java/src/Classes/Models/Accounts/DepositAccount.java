...
public class DepositAccount implements IAccount{
    ...
    public DepositAccount(Customer owner, int daysBeforeExpiry, double creditLimit, double commission, double percent){
    ...
    public double withdrawMoney(Transaction newTransaction) throws DepositWithdrawalException, NotEnoughMoneyException {
        if (_daysBeforeExpiry > 0){
            throw new DepositWithdrawalException();
        }
        else{
